first_row = str(input()).split(" ")
second_row = str(input()).split(" ")
third_row = str(input()).split(" ")

if (
    (first_row[0] == second_row[0] == third_row[0] == "1" or
    ...
    first_row[2] == second_row[1] == third_row[0] == "1" or
    third_row[0] == third_row[1] == third_row[2])):
    print("First player won")
elif (
    (first_row[0] == second_row[0] == third_row[0] == "2" or
    ...
    first_row[2] == second_row[1] == third_row[0] == "2" or
    third_row[0] == third_row[1] == third_row[2])):
